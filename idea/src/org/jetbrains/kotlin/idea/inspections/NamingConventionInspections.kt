...
abstract class NamingConventionInspection(private val entityName: String,
                                          private val defaultNamePattern: String) : AbstractKotlinInspection() {
...
class PrivatePropertyNameInspection : PropertyNameInspectionBase(PropertyKind.PRIVATE, "Private property", "_?[a-z][_A-Za-z\\d]*")
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean, session: LocalInspectionToolSession): PsiElementVisitor {
        return object : KtVisitorVoid() {
            override fun visitPackageDirective(directive: KtPackageDirective) {
                if (!nameRegex.matches(directive.qualifiedName)) {
